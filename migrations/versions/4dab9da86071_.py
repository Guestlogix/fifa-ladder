...
Revision ID: 4dab9da86071
Revises: 
Create Date: 2018-09-13 18:14:24.408362
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['player_a_id'], ['game_player.id'], ),
    sa.ForeignKeyConstraint(['player_b_id'], ['game_player.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
